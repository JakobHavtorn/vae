...
from semi.utils import log_sum_exp, enumerate_discrete
from semi.inference import log_standard_categorical
...
class SVI(nn.Module):
    """
    Stochastic variational inference (SVI) [1].

    References
    [1] http://jmlr.org/papers/volume14/hoffman13a/hoffman13a.pdf
    """
